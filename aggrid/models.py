...
class GeographyLocationeta(models.Model):
    ...
    destination = models.ForeignKey(GeographyLocality, models.DO_NOTHING,related_name="destination" )
    origin = models.ForeignKey(GeographyLocality, models.DO_NOTHING,related_name="origin" )
...
class LeadmanagerLead(models.Model):
    ...
    from_campaign = models.ForeignKey(CampaignmanagerCampaign, models.DO_NOTHING, blank=True, null=True)
    assigned_to = models.ForeignKey(CompanyCallcenter, models.DO_NOTHING,related_name="assigned_to", blank=True, null=True)
    ...
    opened_by = models.ForeignKey(CompanyCallcenter, models.DO_NOTHING,related_name="opened_by", blank=True, null=True)
...
class RequestbookingBooking(models.Model):
    ...
    created_by = models.ForeignKey('AuthUser', models.DO_NOTHING,related_name="created_by", blank=True, null=True)
    ...
    assign_to = models.ForeignKey('AuthUser', models.DO_NOTHING,related_name="assign_to", blank=True, null=True)
...
class RequestbookingC24Visit(models.Model):
    ...
    allowance_transaction = models.ForeignKey(AccountingTransaction, models.DO_NOTHING,related_name="allowance_transaction", blank=True, null=True)
    fee_transaction = models.ForeignKey(AccountingTransaction, models.DO_NOTHING,related_name="fee_transaction" , blank=True, null=True)
...
class RequestbookingVisittracking(models.Model):
    ...
    cg_spoke_to = models.ForeignKey(CompanyCallcenter, models.DO_NOTHING,related_name="cg_spoke_to", blank=True, null=True)
    cust_spoke_to = models.ForeignKey(CompanyCallcenter, models.DO_NOTHING,related_name="cust_spoke_to", blank=True, null=True)
...
class UsermanagementC24Customer(models.Model):
    ...
    created = models.DateTimeField()
    gender = models.CharField(max_length=2, blank=True, null=True)
    billing_address = models.ForeignKey(GeographyCareaddress, models.DO_NOTHING,related_name="billing_address", unique=True, blank=True, null=True)
    alt_phnum = models.ForeignKey(InteractionmanagerPhonenumber, models.DO_NOTHING,related_name="alt_phnum", blank=True, null=True)
    auth_user = models.ForeignKey('AuthUser', models.DO_NOTHING, unique=True, blank=True, null=True)
    email = models.CharField(max_length=254, blank=True, null=True)
    phnum = models.ForeignKey(InteractionmanagerPhonenumber, models.DO_NOTHING,related_name="phnum1" )
    ...
    preferred_address = models.ForeignKey(GeographyCareaddress, models.DO_NOTHING,related_name="preffered_address", blank=True, null=True)
...
class UsermanagementC24Provider(models.Model):
    ...
    phone = models.ForeignKey(InteractionmanagerPhonenumber, models.DO_NOTHING,related_name="phone", unique=True, blank=True, null=True)
    alt_phone_0 = models.ForeignKey(InteractionmanagerPhonenumber, models.DO_NOTHING,related_name="alt_phone_0", db_column='alt_phone_id', blank=True, null=True)  # Field renamed because of name conflict.
...
class HelpdeskTicketdependency(models.Model):
    depends_on = models.ForeignKey(HelpdeskTicket, models.DO_NOTHING,related_name="depends_on")
    ticket = models.ForeignKey(HelpdeskTicket, models.DO_NOTHING,related_name="ticket")
